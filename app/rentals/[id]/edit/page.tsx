...
} from '@/utils/server-action/rentals';
...
async function EditRentalPage({ params }: { params: { id: string } }) {
  ...
  const amenities: Amenity[] = JSON.parse(property.amenities);
  return (
    <section>
      ...
      <div className='border p-8 rounded-md'>
        ...
        <FormContainer action={updatePropertyAction}>
          ...
          <div className='grid md:grid-cols-2 gap-8 mb-4 mt-8'>
            ...
            <SelectCategory defaultValue={property.category} />
            <SelectCountry defaultValue={property.country} />
          </div>
          <TextAreaInput
            name='description'
          ...
          <AmenitiesInput defaultValue={amenities} />
